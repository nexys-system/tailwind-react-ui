import {contextBgColors, contextTextColors} from "../type.js";
...
export const get = ({variant, color, textColor}, disabled = false, isLoading, theme = "light") => {
  ...
  if (variant === "filled") {
    classArray.push(`${bgColor} hover:${bgColor}-400`);

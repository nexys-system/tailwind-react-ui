...
export const Check = IconFactorySVG("M5 13l4 4L19 7", 1);
export const ChevronDown = IconFactorySVG("M19 9l-7 7-7-7", 1);
export const ChevronLeft = IconFactorySVG("M15 19l-7-7 7-7", 1);
...
export const DoubleChevronRight = IconFactorySVG(
...
export const Menu = IconFactorySVG("M4 6h16M4 12h16M4 18h16", 1);
...
export const Selector = IconFactorySVG("M8 9l4-4 4 4m0 6l-4 4-4-4", 2);
